...
> **Asosiy g'oya:** Tartibsizlikni AIga bersangiz, u sizga tartibsizlikni 10 baravar tezroq qilib qaytaradi. AI bankda mo''jiza yaratmaydi, u faqat to'g'ri bo'laklarga ajratilgan aniq jarayon (workflow) ichidagina ishlaydi. Bu modulda biz nazariyani yig'ishtirib, har bir ishtirokchi o'z bo'limidagi eng og'riqli ishni 5–7 ta aniq qadamga bo'lishni mashq qiladi.
...
| 8 | End-to-end · 5 qadam, 2 tasi AIda | `.flow` + AI badges | ~5 daq | 03 Vazifani bo'lish |
...
| 11 | Tez-tez uchraydigan xato · va to'g'risi | `.myth` 2 juft | ~3 daq | 04 Mashq |
...
**Lead matn:**
AI ishni to'g'ri bajarishi uchun ishni to'g'ri bo'laklarga bo'lish kerak — qadam, ma'lumot, qaror.
...
Shu paytgacha biz AI nima ekanligi, uning xavflari haqida ko'p gaplashdik. Lekin hozirgi 60 daqiqada biz gaplashishni to'xtatamiz. Qo'limiz bilan ishlaymiz. 

Agar siz AIga shunchaki 'menga hisobot yozib ber' desangiz — u sizga chiroyli, lekin mutlaqo yaroqsiz matn beradi. Nima uchun? Chunki ishning strukturasi yo'q. AI ishni to'g'ri bajarishi uchun, avval siz o'sha ishni to'g'ri bo'laklarga bo'lishingiz kerak. Qani, ketdik."
...
*(3-karta)* Eng muhimi — qanday qilib katta vazifani AI tushunadigan kichik bo'laklarga ajratishni o'rganamiz.
*(4-karta)* Va oxirgi 25 daqiqani stollarda o'tkazamiz. Har biringiz o'z bo'limingizdagi bitta ishni qog'ozga tushirasiz va uni AI uchun tayyorlaysiz.
...
**Lead matn:**
AI sizga yordam beradimi yoki adashtiradimi — buni siz bergan jarayon hal qiladi. Tartibsiz topshiriq → tartibsiz javob. Aniq qadam → aniq javob.
...
AI ham xuddi shunday. Agar siz unga 47 betlik mijoz arizasini tashlab, 'shu bo'yicha qaror chiqar, xat yoz va hisobotga tushir' desangiz — u adashadi. U sizga chiroyli yolg'onlarni to'qib berishni boshlaydi.

Bizning maqsadimiz — chap tomondagi vahimani o'ng tomondagi aniq konveyerga aylantirish. AI bitta vaqtda bitta qadamni ko'rishi kerak. Bitta kirish ma'lumoti. Bitta vazifa. Bitta aniq javob."
...
*(1-karta)* Birinchisi — kamroq qayta ishlash. AI sizga yozib bergan xulosa 'sal g'alati' chiqsa, uni to'g'rilashga noldan yozgandan ko'proq vaqt ketadi. Kichik qadamlar buni yo'q qiladi.

*(2-karta)* Ikkinchisi — tekshirish osonligi. Bu Markaziy Bank. Bizga 'qora quti' kerak emas. Agar AI xato qilsa, qaysi qadamda xato qilganini ko'ra olishimiz kerak. Audit so'rasa, ko'rsatib bera olishimiz shart.
...
**Speaker notes:**
"Biz kelishib olgan edik: kurs davomida AI lug'atimizni yig'ib boramiz. Bugun menyuda ikkita so'z bor.
...
AI super-aqlli bo'lishi mumkin, lekin u diqqatni jamlashda yosh bolaga o'xshaydi. Unga kichik, aniq luqmalar berish kerak. Shu — vazifani bo'laklash."
...
**Lead matn:**
Har bir bank ishi — ariza, shikoyat, hisobot — shu 5 qadamga sig'adi. AI 3-qadamga (Tahlil) eng yaxshi tushadi.

**Vizual elementlar:**
5 qadamli gorizontal flow diagrammasi (`.flow`).
Kirish → Tekshiruv → **TAHLIL** (yorqin ko'k rangda, AI miya ikonasi bilan) → Xulosa → Yetkazish.

**Speaker notes:**
"Endi Markaziy Bankdagi ishingizga qaraylik. Xoh tijorat banki hisobotini ko'ring, xoh fuqaro murojaatiga javob bering, xoh tekshiruv materialini tahlil qiling — hamma ish shu 5 ta qadamdan iborat.
...
AI sizning o'rningizga tijorat banki vakili bilan gaplashmaydi, AI sizning o'rningizga hujjatga muhr bosmaydi. Lekin uzun hisobotni o'qib, ichidan tekshiruv talab qiladigan joylarni topib berish — mana buni AI sizdan oldin qila oladi. Yakuniy gap baribir sizniki."
...
**Lead matn:**
"Kredit memo yoz" — AI uchun juda katta. Uni 3 ta kichik vazifaga bo'lsak, har biri 1 ta aniq natijani beradi.
...
Tasavvur qiling, siz AIga 'Mijoz uchun kredit memo yoz' dedingiz. Bu bitta katta vazifa. AI nima qiladi? Shablon bo'yicha nimadir to'qiydi. Natija yuzaki bo'ladi.

Endi buni 3 ga bo'lamiz.
*(1-karta)* AIga aytamiz: Faqat faktlarni yig'. Daromadi qancha, qarzi qancha? Boshqa narsa qo'shma.
...
## Slide 8 — End-to-end · 5 qadam, 2 tasi AIda

**Sarlavha / chip:**
BANK MISOLI · TIJORAT BANKI HISOBOTI
END-TO-END · 5 QADAM, **2 TASI AI BAJARADI**.

**Lead matn:**
Bu — shu bugungi modulning aniq xulosasi. Inson hamma joyda emas, AI hamma joyda emas. Har biri o'z qadamida.

**Vizual elementlar:**
Gorizontal 5 bosqichli flow.
1. Hisobot qabul, 2. **Raqam va jadval ajratish** (AI chipi), 3. Normativ tekshiruv, 4. **Risk va savollar qoralamasi** (AI chipi), 5. Yakuniy xulosa va imzo.

**Speaker notes:**
"Mana bu slayd — bugungi kungi eng muhim slayd. Agar ertaga kimdir sizdan 'AI Markaziy Bankda qanday ishlaydi?' deb so'rasa, shu rasmni ko'rsating.

Bu — tijorat bankidan kelgan hisobotni ko'rib chiqish jarayoni. Ko'rib turibsizmi, AI hamma joyni egallab olgani yo'q. U faqat o'ziga tegishli 2 ta joyda o'tiribdi.
...
Lekin 3-qadam — normativ tekshiruv — inson ko'zi. 5-qadam yakuniy xulosa va rasmiy javob — mas'ul xodim imzosi. Mas'uliyat odamda qoladi, qora mehnat AIga o'tadi.

Bu pattern hisobotda ham, murojaatga javobda ham, tekshiruv dalolatnomasida ham bir xil ishlaydi."

---

## Slide 9 — Hand-off nuqtalari · kim nimani qiladi

**Sarlavha / chip:**
HAND-OFF NUQTALARI · **KIM NIMANI QILADI**.
...
Chapda (ko'k): **✓ AI QILADI** — matndan fakt ajratadi, jadvalni solishtiradi, savollar ro'yxatini tuzadi, xat va memo qoralamasini beradi.
O'ngda (qizil): **→ INSON QILADI** — maxfiy ma'lumot chegarasini belgilaydi, normativ talqinni tekshiradi, istisno holatni baholaydi, yakuniy xulosa va imzoni beradi, audit uchun izoh qoldiradi.

**Speaker notes:**
"Jarayonni quryapmiz. Kim nima qilishini aniq chizib olishimiz kerak. Buni biz 'topshirish nuqtasi' deymiz. AI qayergacha boradi, qayerdan siz olasiz?

Chap tomonga qarang — bularning hammasi vaqt o'g'irlaydigan ishlar. Hujjatdan ma'lumot qidirish, jadvalni solishtirish, xatning qoralamasini yozish. Buni AIga beramiz.

Lekin o'ng tomonga qarang. Bu yerda 3 ta majburiy nazorat bor: birinchi — qaysi ma'lumotni AIga umuman bermaymiz (maxfiylik chegarasi). Ikkinchi — AI bergan natijani normativga moslab tekshirish. Uchinchi — har bir AI qadami uchun aniq mas'ul shaxs va audit izi.

Eng pastki qator — **istisno hollar**. Markaziy Bankda har kuni shunday holat keladiki, qog'ozdagi qoida ishlamaydi. Tijorat bankining holatini tushunish, regulyator sifatida qaror qabul qilish kerak. AI buni eplayolmaydi. Uning uchun hammasi oq yoki qora. Kulrang zonani faqat siz hal qilasiz."
...
01 Bo'limingizdagi eng ko'p takrorlanuvchi ishni tanlang: hisobot ko'rib chiqish, murojaatga javob, tekshiruv materialini tahlil qilish yoki rahbariyat uchun ma'lumotnoma. Uni 5–7 ta qadamga yozing.
02 Har qadamga mas'ul belgisini qo'ying: **xodim · rahbar · AI yordamchi**.
03 AI bajara oladigan 1–2 qadamni tanlang. Yoniga: AIga **bermaslik** kerak bo'lgan ma'lumot yoki qaror nima?

**Speaker notes:**
*(Ohangni o'zgartiring, harakatga chaqiruvchi ovoz)*
"Bo'ldi. Men yetarlicha gapirdim. Endi navbat sizga.

Stollaringizda katta plakatlar va markerlar bor. Hozir har bir stol o'z bo'limidan bitta ishni tanlaydi: hisobot ko'rib chiqish, murojaatga javob, tekshiruv materialini tahlil qilish yoki rahbariyat uchun ma'lumotnoma. Eng zerikarli, eng ko'p vaqt oladiganini oling.

12 daqiqada stolingiz bitta mini-jarayon xaritasini topshiradi. Aniq shakl:
1. Jarayon nomi (1 qator).
2. 5–7 ta qadam.
3. Har qadamda mas'ul: xodim, rahbar yoki AI yordamchi.
4. AI ishlatish mumkin bo'lgan 1–2 qadam.
5. AIga **bermaslik** kerak bo'lgan ma'lumot yoki qaror.
6. Eng yuqori ta'sirli bitta qadam — yulduzcha bilan belgilang.
...
## Slide 11 — Tez-tez uchraydigan xato · va to'g'risi
...
Xato: «AI aytdi, demak to'g'ri» / To'g'ri: «AI javobi — qoralama. Manba, norma va mas'ul xodim tekshiruvi kerak».
...
Birinchisi — Excel'da 2000 satrni AIga berib, 'menga hammasini qilib ber' deyish. AI adashadi, sizning asabingiz buziladi. Bitta promt — bitta natija. Katta vazifani qadamlarga bo'lib, AIdan bir nafasda kredit memo, javob xati va hisobotni so'ramaslik kerak.

Ikkinchisi — huquqiy xato. AI javobini hujjatga aylantirib qo'yish. Hech qachon 'AI aytdi, demak to'g'ri' degan gap Markaziy Bankda yangramasligi kerak. AI har doim faqat qoralama beradi. Qaror uchun manba, norma va mas'ul xodim tekshiruvi shart. Imzo — sizniki, javobgarlik — tashkilotniki."
...
**Vizual elementlar:**
Uchta xulosa qatori.
1. **Strukturalanmagan jarayonni AI tuzatmaydi** — u faqat tartibsiz natijani tezroq beradi.
2. **5 ta qadam · 2 tasini AI bajaradi** — bank jarayoni shunchalik sodda. AI qoralama beradi, xodim tekshiradi, tashkilot javobgar bo'ladi.
3. **Katta vazifa = 3 ta kichik**. Bo'laklash bo'lmasa — sifat har safar boshqa.
Pastda: Lug'at recap qatori.

**Speaker notes:**
"Yakunlaymiz. Agar bugungi 60 daqiqadan faqat uchta narsani yodda saqlasangiz, shular bo'lsin:

Birinchisi: Strukturalanmagan jarayonni AI tuzatmaydi. 
Ikkinchisi: Jarayonlar vahimali emas. 5 ta qadam, atigi 2 tasida AI bor.
Uchinchisi: Katta vazifani doim 3 ga bo'ling. 

Endi, an'anamizga ko'ra, bugungi lug'atimizni birga qaytaramiz. Men atamani aytaman, siz ma'nosini. Tayyormisiz?

Workflow nima edi? 
*(Zal bilan birga: "Jarayon zanjiri, 5 ta qadam")*

Task Decomposition nima edi?
*(Zal bilan birga: "Katta vazifani 3 ga bo'lish")*
...
Asosiy savol: o'z bo'limingizda qaysi qadam AIga mos keladi, qaysi qadamda mas'uliyat insonda qolishi shart? 'Bizda 5 ta emas, 12 ta qadam-ku' deydiganlar bormi? Marhamat, eshitaman."
...
- [ ] A4 bo'sh plakat blankasi har stolga (5–7 katakcha + AI/INSON ustun) — 10-slayd mashqi uchun oldindan tayyorlab qo'yilishi shart.
...
- [ ] Slayd 8 (tijorat banki hisoboti) — agar zalda HR/marketing xodimi ko'p bo'lsa, ular uchun ekvivalent misol yodda tayyor turishi kerak (Masalan HR: ariza kelishi → AI rezyumeni tahlil qilishi → suhbat → AI taklif matnini yozishi → imzo).
